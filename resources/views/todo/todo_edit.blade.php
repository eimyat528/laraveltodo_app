...
<div class="container m-5">
        <div class="d-flex justify-content-between">
            ...
            <div>
            <h3 class="text-center font-weight-bold text-white">Edit Task</h5>
            </div>
        </div>
        ...
        <div class="card-body">
                  ...
                  <form action="/todo/{{$todo ->id}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="" cols="30" rows="10" class="form-control">{{old('description',$todo->description)}}</textarea>
                        </div>
